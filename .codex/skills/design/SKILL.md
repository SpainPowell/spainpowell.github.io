---
name: design
description: "Creates visual assets: logos, icons, banners, social images, slide decks, CIP mockups, and brand packages (Gemini image generation). Use when the user asks to design or generate a logo, icon, banner, social-media image, presentation, pitch deck, or brand identity asset. Not for writing app UI code."
...
> **Note:** references to `ai-artist`, `ai-multimodal`, `chrome-devtools`, `assets-organizing`, `project-management`, and `/ckm:` skills below are external claudekit skills NOT installed in this harness. Where they appear, substitute: Playwright/manual screenshots for capture, and skip the orchestration steps.
