---
name: ui-ux-pro-max
description: "UI/UX design intelligence and audit reference: searchable styles, color palettes, font pairings, UX guidelines, and chart guidance. Use when reviewing or auditing existing UI for UX, accessibility, or visual-quality issues, when the user says a screen looks off, generic, or unpolished, or when choosing a style direction, palette, or typography for a screen. For this project the primary stack is React Native."
---
...
Rule summaries by category live in `references/quick-reference.md` — read it when you need the condensed rule list.
...
Read `references/common-rules-checklist.md` before delivering UI work — it holds the professional-UI rules and the final checklist.
